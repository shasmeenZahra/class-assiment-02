      ...
      <main className={styles.container}>
        <div className={styles.aboutSection}>
          ...
          <div className={styles.content}>
            <h2>About Me</h2>
            <p>
              I am a web developer passionate about creating beautiful,
              responsive websites. Hello! I am a passionate web developer with a
            ...
            <p>
              ...
              approach to problem-solving, I am constantly exploring new
            ...
            <p>
              ...
              meaningful. Beyond code, I am a believer in continuous growth,
              whether its through learning new skills, collaborating with
              others, or pushing the boundaries of what is possible in web
              development. I am excited to connect and work with others who share
